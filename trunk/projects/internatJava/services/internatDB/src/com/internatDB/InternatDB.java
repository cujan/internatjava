    ...
    implements DataServiceManagerAccess, LiveDataService
{
    ...
    public com.internatdb.data.Trieda getTriedaById(Integer id, PagingOptions pagingOptions) {
        List<com.internatdb.data.Trieda> rtn = ((List<com.internatdb.data.Trieda> ) dsMgr.invoke(taskMgr.getQueryTask(), (InternatDBConstants.getTriedaByIdQueryName), id, pagingOptions));
        if (rtn.isEmpty()) {
            return null;
        } else {
            return rtn.get(0);
