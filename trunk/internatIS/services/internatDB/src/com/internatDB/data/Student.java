...
public class Student {
    ...
    private Integer idTrieda;
    private Integer idSkola;
    ...
    public Integer getIdTrieda() {
        return idTrieda;
    }

    public void setIdTrieda(Integer idTrieda) {
        this.idTrieda = idTrieda;
    }

    public Integer getIdSkola() {
        return idSkola;
    }

    public void setIdSkola(Integer idSkola) {
